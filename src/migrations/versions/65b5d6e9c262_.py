...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False,autoincrement=True,unique=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False,autoincrement=True,unique=True),
    sa.Column('vacancy_id', sa.Integer(), nullable=False,unique=True),
    sa.Column('applicant_id', sa.Integer(), nullable=False,unique=True),
    sa.Column('manager_id', sa.Integer(), nullable=False,unique=True),
